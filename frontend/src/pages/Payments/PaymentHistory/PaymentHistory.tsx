        ...
        >
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-bold text-[#62ffff]">
                        Payment Details
                    </h2>
                    <button
                        onClick={onClose}
    ...
    if (sortedPayments.length === 0) {
        return (
            <div className="p-6 md:p-4">
                ...
                <div
                    className={`${tableContainerClass} px-10 py-20 text-center`}
                >
        ...
        <div className="p-6 md:p-4">
            ...
            <div className="flex justify-between items-start mb-6 lg:flex-col lg:gap-4">
                ...
                <div className="flex gap-3 lg:w-full">
                    ...
                    <span
                        className="inline-flex items-center gap-2 appearance-none bg-[rgba(19,186,186,0.1)] border border-[rgba(98,255,255,0.2)] text-text-primary px-3.5 py-2 pr-9 rounded-lg text-sm font-medium cursor-pointer outline-none hover:border-[#62ffff] hover:bg-[rgba(19,186,186,0.15)] transition-colors"
                        onClick={() =>
                            setSortOrder((prev) =>
                                prev === "desc" ? "asc" : "desc",
                            )
